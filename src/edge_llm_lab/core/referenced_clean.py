...
class EvalModelsReferenced(BaseEvaluation):
    ...
    def per_model_plots(self, session_locations, timestamp, list_of_models=None, use_polish=True):
        ...
        def _create_model_plots_for_single_model(model_name):
            ...
            from thesis_generators.optimization_comparison import plot_optimization_comparison, plot_gartner_style_energy_analysis
    ...
    def get_reference_context_for_round(self,reference_file, round_number=RoundNumber.ZERO):
        ...
        ...     reference_file = "/Users/mariamalycha/Documents/fed-mobile/thesis_generators/source/output/agents/constant_data_en/referenced/reference/reference_constant_data_en.json"
...
if __name__ == "__main__":
    ...
    print(f"📊 Wyniki: source/output/agents/{agent_type_enum.value}/referenced/")
